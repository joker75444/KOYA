--[[
   ...
   ─
│@eljo_ker_m
تم تطوير السورس بواسطه مطور سورس الجوكر ✾
│@eljo_ker_m ‿ @eljo_ker_m
#-------------------------------------------------------------------
]]
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(blank..":NameBot:")
...
var =  'مطور السورس'
elseif redis:sismember(blank..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(blank..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(blank..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(blank..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(blank..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(blank..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(blank..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(blank..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(blank..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(blank..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(blank..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(blank..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(blank..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(blank..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(blank..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(blank..':SUDO_BOT:')
message = '❍ ** قائمه الـمـطـوريـن : \n\n`❍ مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(blank..'username:'..v)
local count = redis:scard(blank..'mtwr_count'..v)
...
local monsha = redis:smembers(blank..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n❍ قائمه المدراء :*\n\n'
local list = redis:smembers(blank..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(blank..'admins:'..msg.chat_id_)
...
local list = redis:smembers(blank..'whitelist:'..msg.chat_id_)
...
if redis:sismember(blank..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(blank..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(blank..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(blank..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(blank..'gban_users')
...
local list = redis:smembers(blank..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(blank..':Filter_Word:'..msg.chat_id_,word) then 
return  "❍ **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(blank..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(blank..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(blank..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(blank..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(blank..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(blank..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(blank..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(blank..'group:ids')
message = '❍ **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(blank..'group:name'..v)
if info then 
...
<style>*{font-family: 'Harmattan', sans-serif;font-weight: 600;text-shadow: 1px 1px 16px blank;}</style>
<body>
...
redis:del(
blank..'group:add'..id_group,
blank..'lock_link'..id_group, 
blank..'lock_id'..id_group,
blank..'lock_spam'..id_group, 
blank..'lock_webpage'..id_group,
blank..'lock_markdown'..id_group,
blank..'lock_flood'..id_group,
blank..'lock_bots'..id_group,
blank..'mute_forward'..id_group,
blank..'mute_contact'..id_group,
blank..'mute_location'..id_group,
blank..'mute_document'..id_group,
blank..'mute_keyboard'..id_group,
blank..'mute_game'..id_group,
blank..'mute_inline'..id_group,
blank..'lock_username'..id_group,
blank..'num_msg_blank'..id_group,
blank..'replay'..id_group
)
redis:srem(blank..'group:ids',id_group)
end
...
redis:hset(blank..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(blank..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(blank..'group:add'..msg.chat_id_) then  return '❍ **المجموعة تم تفعيلها مُسبقاً . ' end
...
redis:setex(blank..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(blank..':addnumberusers') or 0)
...
local lock_service = redis:get(blank..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(blank..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(blank..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
blank..'group:add'..msg.chat_id_,true,
blank..'lock_link'..msg.chat_id_,true, 
blank..'lock_id'..msg.chat_id_,true,
blank..'lock_spam'..msg.chat_id_,true,
blank..'lock_webpage'..msg.chat_id_,true,
blank..'lock_markdown'..msg.chat_id_,true,
blank..'lock_flood'..msg.chat_id_,true,
blank..'lock_bots'..msg.chat_id_,true,
blank..'mute_forward'..msg.chat_id_,true,
blank..'mute_contact'..msg.chat_id_,true,
blank..'mute_location'..msg.chat_id_,true,
blank..'mute_document'..msg.chat_id_,true,
blank..'mute_keyboard'..msg.chat_id_,true,
blank..'mute_game'..msg.chat_id_,true,
blank..'mute_inline'..msg.chat_id_,true,
blank..'lock_username'..msg.chat_id_,true,
blank..'num_msg_blank'..msg.chat_id_,5, 
blank..'replay'..msg.chat_id_,true
)

redis:sadd(blank..'group:ids',msg.chat_id_) 
redis:sadd(blank..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(blank..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(blank..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(blank..'group:add'..msg.chat_id_) then return '** المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(blank..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(blank..'username:'..UserID,'username',Resolv)
redis:sadd(blank..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(blank..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(blank..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(blank..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(blank..'username:'..UserID,'username',Resolv)
redis:sadd(blank..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(blank..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(blank..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(blank..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(blank..'username:'..UserID, 'username', Resolv)
redis:sadd(blank..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(blank..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(blank..'whitelist:'..ChatID,UserID)
...
if redis:sismember(blank..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(blank..'username:'..UserID, 'username', Resolv)
redis:sadd(blank..'owners:'..ChatID,UserID)
...
if redis:sismember(blank..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(blank..'username:'..UserID, 'username', Resolv)
redis:sadd(blank..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(blank..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(blank..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(blank..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(blank..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(blank..'msgs:'..UserID..':'..ChatID) or 1
...
elseif UserID == 1317966118 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظر المبرمج الجوكر\n") 
elseif UserID == 1424388256 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظر البابا جاك\n") 
elseif UserID == 1027286620 then 
...
redis:hset(blank..'username:'..UserID, 'username', Resolv)
redis:sadd(blank..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(blank..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(blank..'banned:'..ChatID,UserID)
...
elseif UserID == 1317966118 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك كتم المبرمج الجوكر\n") 
elseif UserID == 1424388256 then 
...
if redis:sismember(blank..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(blank..'username:'..UserID, 'username', Resolv)
redis:sadd(blank..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(blank..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(blank..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم الغاء كتمه  \n',17,USERCAR) 
end
...
elseif UserID == 1424388256 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظر البابا جاك\n")  
elseif UserID == 1519444978 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظر مطور السورس\n") 
elseif UserID == 1533230723 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظر مطور السورس\n") 
elseif UserID == 1669332184 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظر مطور السورس\n") 
elseif redis:sismember(blank..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك حظر المطور\n") 
end
...
redis:hset(blank..'username:'..UserID, 'username',Resolv)
redis:sadd(blank..'gban_users',UserID)
...
redis:srem(blank..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم الغاء حظره العام \n',17,USERCAR) 
end
...
elseif UserID == 1317966118 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المبرمج الجوكر\n") 
elseif UserID == 1424388256 then 
...
if redis:sismember(blank..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(blank..'username:'..UserID, 'username', Resolv)
redis:sadd(blank..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(blank..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(blank..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك تقييد المطور الاساسي\n") 
elseif UserID == 1317966118 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك تقييد المبرمج الجوكر\n") 
elseif UserID == 1424388256 then 
...
redis:hset(blank..'username:'..UserID, 'username', UserName)
redis:sadd(blank..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(blank..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'❍ **العضو » ❪ '..UserName..' ❫\n❍ **الايدي » ❪ `'..UserID..'` ❫\n❍ **تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المطور الاساسي\n")
elseif UserID == 1317966118 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المبرمج الجوكرn") 
elseif UserID == 1424388256 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد البابا جاك\n") 
elseif UserID == 1519444978 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد مطور السورس\n") 
...
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المطور\n") 
elseif
redis:sismember(blank..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(blank..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المدير\n") 
elseif redis:sismember(blank..'admins:'..ChatID,UserID) then 
...
Restrict(ChatID,UserID,1)
redis:hset(blank..'username:'..UserID, 'username', Resolv)
redis:sadd(blank..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(blank..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(blank..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'❍ **العضو » '..USERNAME..' \n❍ ** الايدي » (`'..UserID..'`)\n❍ **انه بالتأكيد ليس مطور \n') end
redis:srem(blank..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'❍ العضو » ❪ '..USERNAME..' ❫\n❍ الايدي » ❪ '..UserID..' ❫\n❍ تم تنزيله من المطور \n',17,USERCAR) 
end
...
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد المطور الاساسي\n")
elseif UserID == 1317966118 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك المبرمج الجوكر\n")  
elseif UserID == 1424388256 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد البابا جاك\n") 
elseif UserID == 1519444978 then 
return sendMsg(ChatID,MsgID,"❍ **لا يمكنك طرد مطور السورس\n") 
...
if redis:get(blank..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(blank..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(blank..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(blank..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*❍*` اعدادات المجموعه :` \n"
.."\n❍ التعديل «» "..(redis:get(blank..'lock_edit'..msg.chat_id_) or 'false')
.."\n❍ الروابط «» "..(redis:get(blank..'lock_link'..msg.chat_id_) or 'false')
.."\n❍ التاك «» "..(redis:get(blank..'lock_tag'..msg.chat_id_) or 'false')
.."\n❍ المعرفات «» "..(redis:get(blank..'lock_username'..msg.chat_id_) or 'false')
.."\n❍ التكرار «» "..(redis:get(blank..'lock_flood'..msg.chat_id_) or 'false')
.."\n❍ الكلايش «» "..(redis:get(blank..'lock_spam'..msg.chat_id_) or 'false')
.."\n❍ الويب «» "..(redis:get(blank..'lock_webpage'..msg.chat_id_) or 'false')
.."\n❍ الماركدوان «» "..(redis:get(blank..'lock_markdown'..msg.chat_id_) or 'false')
.."\n❍ بالطرد البوتات «» "..(redis:get(blank..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n❍ البوتات «» "..(redis:get(blank..'lock_bots'..msg.chat_id_) or 'false')
.."\n❍ عدد التكرار «» "..(redis:get(blank..'num_msg_blank'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n❍`اعدادات الوسائط :`\n"
.."\n*❍ *المتحركه «» "..(redis:get(blank..'mute_gif'..msg.chat_id_) or 'false')
.."\n❍ الدردشه «» "..(redis:get(blank..'mute_text'..msg.chat_id_) or 'false')
.."\n❍ الانلاين «» "..(redis:get(blank..'mute_inline'..msg.chat_id_) or 'false')
.."\n❍ الالعاب «» "..(redis:get(blank..'mute_game'..msg.chat_id_) or 'false')
.."\n❍ الصور «» "..(redis:get(blank..'mute_photo'..msg.chat_id_) or 'false')
.."\n❍ الفيديو «» "..(redis:get(blank..'mute_video'..msg.chat_id_) or 'false')
.."\n❍ البصمات «» "..(redis:get(blank..'mute_audio'..msg.chat_id_) or 'false')
.."\n❍ الصوت «» "..(redis:get(blank..'mute_voice'..msg.chat_id_) or 'false')
.."\n❍ الملصقات «» "..(redis:get(blank..'mute_sticker'..msg.chat_id_) or 'false')
.."\n❍ الجهات «» "..(redis:get(blank..'mute_contact'..msg.chat_id_) or 'false')
.."\n❍ التوجيه «» "..(redis:get(blank..'mute_forward'..msg.chat_id_) or 'false')
.."\n❍ الموقع «» "..(redis:get(blank..'mute_location'..msg.chat_id_) or 'false')
.."\n❍ الملفات «» "..(redis:get(blank..'mute_document'..msg.chat_id_) or 'false')
.."\n❍ الاشعارات «» "..(redis:get(blank..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n❍ الكيبورد «» "..(redis:get(blank..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*❍*`اعدادات اخرى : `"
.."\n\n*❍*الترحيب «» "..welcomex
.."\n*❍*الردود «» "..replayx
...
.."\n*❍*الويب «» "..(redis:get(blank..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*❍*الماركدوان «» "..(redis:get(blank..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*❍*البوتات بالطرد «» "..(redis:get(blank..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*❍*البوتات «» "..(redis:get(blank..'lock_bots'..msg.chat_id_) or 'false')
.."\n*❍*عدد التكرار «» "..(redis:get(blank..'num_msg_blank'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*❍*اعدادات التقـييد :\n"
.."\n*❍*التقييد بالتوجيه «» "..(redis:get(blank..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد بالصور «» "..(redis:get(blank..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد بالروابط «» "..(redis:get(blank..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد بالمتحركه «» "..(redis:get(blank..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*❍*التقييد الفيديو «» "..(redis:get(blank..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
